...
@Service
class EmailService(
    private val javaMailSender: JavaMailSender, // only created at runtime
    private val templateService: EmailTemplateService,
    @param:Value("\${chrip.email.from}") private val emailFrom: String,
    @param:Value("\${chrip.email.url}") private val baseUrl: String,
) {
    ...
    fun sendVerificationEmail(
        ...
        sendHtmlEmail(
            to = email,
            subject = "Verify your Chrip account.",
            html = htmlContent
        )
    }
    ...
    fun sendPasswordResetEmail(
        ...
        sendHtmlEmail(
            to = email,
            subject = "Reset your Chrip password.",
            html = htmlContent
        )
    }
