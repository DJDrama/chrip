package com.dj.www.chrip.api.config

import com.dj.www.chrip.domain.exception.RateLimitException
import com.dj.www.chrip.infra.rate_limiting.IpRateLimiter
import com.dj.www.chrip.infra.rate_limiting.IpResolver
...
class IpRateLimitInterceptor(
    ...
    @param:Value("\${chrip.rate-limit.ip.apply-limit}")
